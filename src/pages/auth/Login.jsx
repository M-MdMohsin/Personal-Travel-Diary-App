  ...
  return (
    <div className="h-screen bg-cyan-50 overflow-hidden relative">
      ...
      <div className="container h-screen flex items-center justify-center px-20 mx-auto">
        <div className="w-2/4 h-[90vh] flex items-end bg-[url('https://images.pexels.com/photos/1386604/pexels-photo-1386604.jpeg')] bg-cover bg-center rounded-lg p-10 z-50">
          <div>
